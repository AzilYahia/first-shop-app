...
import 'package:shop_appp/core/view/widgets/tile_list.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Tile(
                            image: 'images/svg/edit.svg',
                            text: 'Edit Profile',
                            onPressed: () {}
                            // => Get.to(() => EditProfileView()),
                            ),
                        Tile(
                            image: 'images/svg/history.svg',
                            text: 'Order History',
                            onPressed: () {}
                            // => Get.to(() => OrderHistoryView()),
                            ),
                        Tile(
                            image: 'images/svg/card.svg',
                            text: 'Cards',
                            onPressed: () {}
                            // => Get.to(() => CardsView()),
                            ),
